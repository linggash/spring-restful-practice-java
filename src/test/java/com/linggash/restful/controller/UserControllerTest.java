...
class UserControllerTest {
    ...
    void testRegisterSuccess() throws Exception{
        ...
        request.setUsername("lingga");
        request.setPassword("rahasia");
        request.setName("Lingga");
    ...
    void updateUserSuccess() throws Exception{
        ...
        mockMvc.perform(
            ...
            assertNull(response.getErrors());
            assertEquals("Lingga", response.getData().getName());
            assertEquals("test", response.getData().getUsername());

            User userDb = userRepository.findById(response.getData().getUsername()).orElse(null);
            assertNotNull(userDb);
            assertTrue(BCrypt.checkpw("lingga123", userDb.getPassword()));
        });
    }
